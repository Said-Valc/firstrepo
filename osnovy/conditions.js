...
*/
// тут твой код
if(userAge < 35) console.log('Ты пацан');
...
if(isAdmin === false) console.log('Доступ запрещен');
...
if(password === realPassword) console.log('Правильный пароль');
...
*/
// тут твой код
if(typeof myAge == 'number') console.log('Тип переменной является number');
// задание 5
const x = 2.7;
const y = -6;
/*
